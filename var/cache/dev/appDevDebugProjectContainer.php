...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.firewall.map.context.home' => 'getSecurity_Firewall_Map_Context_HomeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'evaluacion_docente17', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity'), 1 => ($this->targetDirs[3].'/src/Admin/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Admin/UnadBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Admin/MedBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Gedmo\\Translatable\\Entity');
        $c->addDriver($b, 'Admin\\UserBundle\\Entity');
        $c->addDriver($b, 'Admin\\UnadBundle\\Entity');
        $c->addDriver($b, 'Admin\\MedBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Translatable\\Entity', 'AdminUserBundle' => 'Admin\\UserBundle\\Entity', 'AdminUnadBundle' => 'Admin\\UnadBundle\\Entity', 'AdminMedBundle' => 'Admin\\MedBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3d3b237d2e911c377aa416d131759b80853a3ec23fbc3731018c917deadd6839');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.home' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/home$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    /**
     * Gets the 'security.firewall.map.context.home' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admon');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/doc');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/dec');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/unad');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/aval');

        $p = new \Symfony\Component\Security\Http\AccessMap();
        $p->add($i, array(0 => 'ROLE_USER'), NULL);
        $p->add($j, array(0 => 'ROLE_ADMIN'), NULL);
        $p->add($k, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ADMON'), NULL);
        $p->add($l, array(0 => 'ROLE_DOC', 1 => 'ROLE_ADMIN'), NULL);
        $p->add($m, array(0 => 'ROLE_DEC'), NULL);
        $p->add($n, array(0 => 'ROLE_DEC', 1 => 'ROLE_ADMIN', 2 => 'ROLE_DOC', 3 => 'ROLE_SECA', 4 => 'ROLE_ADMON', 5 => 'ROLE_AVAL'), NULL);
        $p->add($o, array(0 => 'ROLE_DEC', 1 => 'ROLE_DIRZ', 2 => 'ROLE_ADMON'), NULL);
        ...
        $s->setOptions(array('login_path' => '/login', 'default_target_path' => '/home/inicio', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($p, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'secured_area', $a, $d), 2 => $r, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $q, 'secured_area', $s, $t, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5ca6b533b37584.51554766', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker.secured_area'), 'secured_area', $h, $a, '_quieroser', 'ROLE_ADMIN', $d), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $h, $p, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $q, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $q, '/login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator(($this->targetDirs[3].'/app'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('siga@unad.edu.co');
        $a->setPassword('xxxxxxxxxx');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Admin/UnadBundle/Resources/views'), 'AdminUnad');
        $instance->addPath(($this->targetDirs[3].'/src/Admin/MedBundle/Resources/views'), 'AdminMed');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'evaluacion_docente17',
            'database_user' => 'root',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'siga@unad.edu.co',
            'swiftmailer.mailer.default.transport.smtp.password' => 'xxxxxxxxxx',
